...
const Dashboard = () => {
  ...
  return (
    <AuroraBackground>
      <Navbar2 />
      <div className="flex flex-col items-center justify-center min-h-[80vh] pt-20 px-2">
        <div className="w-full max-w-xl bg-[#181c2f]/90 backdrop-blur-xl rounded-2xl shadow-2xl p-4 sm:p-8 md:p-10 flex flex-col items-center gap-6 border border-blue-900/10">
          <h1 className="text-3xl sm:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-br from-blue-500 to-blue-800 text-center mb-2 drop-shadow-lg">
          ...
          <p className="text-sm sm:text-md text-gray-300 text-center mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
            <Link
              to="/weekly"
              className="py-2 px-6 rounded-lg font-semibold shadow transition bg-blue-600 hover:bg-blue-700 text-white w-full sm:w-auto text-center"
            >
              Weekly Attendance
            </Link>
            <Link
              to="/leaves"
              className="py-2 px-6 rounded-lg font-semibold shadow transition bg-green-600 hover:bg-green-700 text-white w-full sm:w-auto text-center"
            >
              Leaves
            </Link>
          </div>
